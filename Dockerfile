...
RUN wget http://nginx.org/download/nginx-${NGINX_VERSION}.tar.gz && \
    ...
    ./configure --conf-path=/etc/nginx/nginx.conf --pid-path=/var/run/nginx.pid --http-log-path=/var/log/nginx/access.log --error-log-path=/var/log/nginx/error.log --sbin-path=/usr/sbin/nginx --with-http_ssl_module && \
